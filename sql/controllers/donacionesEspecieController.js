...
class DonacionesEnEspecieController {
    ...
    static async update(req, res) {
        try {
            const { id } = req.params;
            const { id_articulo, id_espacio, cantidad, estado_articulo, destino_donacion } = req.body;
            
            // Llamada al modelo para actualizar la donación en especie
            await DonacionesEnEspecieModel.update(id, id_articulo, id_espacio, cantidad, estado_articulo, destino_donacion);
