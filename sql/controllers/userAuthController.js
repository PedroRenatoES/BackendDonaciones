...
class AuthController {
  static async login(req, res) {
    ...
    try {
      ...
      // Verificación de contraseña principal
      ...
      // Verificar si la contraseña actual coincide con alguna anterior (encriptada en Mongo)
      for (const pw of passwordsMongo) {
        const match = await bcrypt.compare(contrasena, pw.password);
        if (match) {
