...
class DonacionesEnEspecieModel {
    ...
    static async update(id, id_articulo, id_espacio, cantidad, estado_articulo, destino_donacion) {
        const pool = await poolPromise;
        await pool.request()
            .input('id', sql.Int, id)
            .input('id_articulo', sql.Int, id_articulo)
            ...
            .input('estado_articulo', sql.VarChar, estado_articulo)
            .input('destino_donacion', sql.VarChar, destino_donacion)
            .query('UPDATE DonacionesEnEspecie SET id_articulo = @id_articulo, id_espacio = @id_espacio, ' +
                'cantidad = @cantidad, estado_articulo = @estado_articulo, destino_donacion = @destino_donacion ' +
